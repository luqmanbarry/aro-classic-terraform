...
- Keep any Spectrum Scale credentials in Azure Key Vault and sync them via External Secrets Operator. Refer to the ESO secret name from your values files instead of committing raw credentials.
