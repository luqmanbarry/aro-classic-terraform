...
- Store any Portworx credentials in Azure Key Vault and read them through External Secrets Operator. Wire the chart values to the ESO secret names instead of committing secrets to Git.
