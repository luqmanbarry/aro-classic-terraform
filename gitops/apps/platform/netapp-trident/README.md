...
- Store any credentials that Trident needs in Azure Key Vault and sync them using External Secrets Operator. Point the chart values at the ESO secret name instead of pasting credentials into Git.
