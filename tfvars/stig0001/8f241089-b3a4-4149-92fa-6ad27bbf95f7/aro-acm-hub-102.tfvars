...
vnet_name="aro-acm-hub-102"

vnet_cidr="10.91.0.0/22"

main_subnet_cidr="10.91.1.0/24"

main_subnet_id="/subscriptions/8f241089-b3a4-4149-92fa-6ad27bbf95f7/resourceGroups/aro-acm-hub-102/providers/Microsoft.Network/virtualNetworks/aro-acm-hub-102/subnets/aro-acm-hub-102-main-subnet"

worker_subnet_cidr="10.91.2.0/24"

worker_subnet_id="/subscriptions/8f241089-b3a4-4149-92fa-6ad27bbf95f7/resourceGroups/aro-acm-hub-102/providers/Microsoft.Network/virtualNetworks/aro-acm-hub-102/subnets/aro-acm-hub-102-worker-subnet"

location="eastus"

platform_environment="dev"

cluster_name="aro-acm-hub-102"

cluster_details_vault_secret_name="openshift-dev-aro-acm-hub-102-cluster-details"

acmhub_details_vault_secret_name="openshift-dev-aro-acm-hub-102-cluster-details"

cluster_service_principal="aro-acm-hub-102"

cluster_sp_client_id="af7bfd4e-4544-481a-b1c3-bc2fb32c21a4"

cluster_resource_group="aro-acm-hub-102"
...
inbound_network_security_group_name="aro-acm-hub-102"
...
custom_dns_domain_prefix="aro-acm-hub-102.dev.eastus.stig0001"

custom_dns_domain_name="aro-acm-hub-102.dev.eastus.stig0001.openshift.sama-wat.com"
...
cluster_infra_tags={"cluster_name"="aro-acm-hub-102","cluster_type"="aro","contact_us"="lbarry@redhat.com","cost_center"="47007","created_by"="lbarry@redhat.com (lbarry@redhat.com)","environment"="dev","organization"="stig0001","team_owner"="platform-ops@example.com"}
