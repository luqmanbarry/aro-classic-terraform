...
vnet_name="aro-stig0004"

vnet_cidr="10.91.0.0/22"

main_subnet_cidr="10.91.1.0/24"

main_subnet_id="/subscriptions/8f241089-b3a4-4149-92fa-6ad27bbf95f7/resourceGroups/aro-stig0004/providers/Microsoft.Network/virtualNetworks/aro-stig0004/subnets/aro-stig0004-main-subnet"

worker_subnet_cidr="10.91.2.0/24"

worker_subnet_id="/subscriptions/8f241089-b3a4-4149-92fa-6ad27bbf95f7/resourceGroups/aro-stig0004/providers/Microsoft.Network/virtualNetworks/aro-stig0004/subnets/aro-stig0004-worker-subnet"

location="eastus"

platform_environment="dev"

cluster_name="aro-stig0004"

cluster_details_vault_secret_name="openshift-dev-aro-stig0004-cluster-details"

acmhub_details_vault_secret_name="openshift-dev-aro-acm-hub-102-cluster-details"

cluster_service_principal="aro-stig0004"

cluster_sp_client_id="9bfa462b-14a2-4259-9f4a-fea8d2e3ff84"

cluster_resource_group="aro-stig0004"
...
inbound_network_security_group_name="aro-stig0004"
...
custom_dns_domain_prefix="aro-stig0004.dev.eastus.stig0000"

custom_dns_domain_name="aro-stig0004.dev.eastus.stig0000.openshift.sama-wat.com"
...
cluster_infra_tags={"cluster_name"="aro-stig0004","cluster_type"="aro","contact_us"="lbarry@redhat.com","cost_center"="47007","created_by"="lbarry@redhat.com (lbarry@redhat.com)","environment"="dev","organization"="stig0000","team_owner"="platform-ops@example.com"}
